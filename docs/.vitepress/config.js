...
import sidebarCt from "./sidebar/ct";
import sidebarGit from "./sidebar/git";
import sidebarVue from "./sidebar/vue";
import navReact from "./nav/react";
import navBooks from "./nav/books";
import navCt from "./nav/ct";
...
export default {
    ...
    themeConfig: {
        ...
        footer: {
            message: '向你敬礼',
            copyright: '<a href="https://portrait.gitee.com/uploads/avatars/user/2951/8855929_ctbaobao_1661007073.png!avatar200" target="view_window">我的宝贝</a>',
        }
    },
}